    ...
    function Editroomtype(id){
        ...
        $('#update_roomprice').val($('#r-price-'+id).html());
        $('#update_roomcapacity').val($('#r-capacity-'+id).html());
...
$('#c-roomtype_select').on('change',function(){
    ...
    // $('#fillter_costumer').on('input',function(){
    //     $('tbody').empty()
    //     var search = $(this).val();
    //             $.ajax({
    //                 url:"Php/display.php",
    ...
    //                         cos.forEach(fillter =>{
    //                             $('tbody').append('<tr>'+ 
    //                                             '<td>'+fillter.Costumer_name +'</td>'+ 
    //                                             '<td>'+fillter.roomNumber +'</td>'+ 
    //                                             '<td>'+fillter.RoomType+'</td>'+ 
    //                                             '<td>'+fillter.Package +'</td>'+ 
    //                                             '<td>'+fillter.Guest +'</td>'+ 
    //                                             '<td>'+fillter.RoomPrice +'</td>'+ 
    //                                             '<td>'+fillter.Amount +'</td>'+ 
    //                                             '<td>'+fillter.Payments +'</td>'+ 
    //                                             '<td>'+fillter.Balance +'</td>'+ 
    //                                             '</tr>')
    //                         })
    //                     }
    //                 }
